...
```{r Letter-freq}
letter.freq <- read.table("~/docs/woRdle/dict-letter-freq",sep = " ")
...
Doing this test with `r reps` repetitions of each tier gives us the following result:
```{r guess-results, echo=F}
guess.data <- read.csv('~/docs/woRdle/guess-table.csv',header = F)
...
# Greens
pre.post.table <- read.csv('~/docs/woRdle/pre-post-simulation-greens.csv',colClasses = c('character','numeric','character','numeric','numeric','numeric','character','numeric','numeric','numeric'))
...
# Yellows
pre.post.table <- read.csv('~/docs/woRdle/pre-post-simulation-yellows.csv',colClasses = c('character','numeric','character','numeric','numeric','numeric','character','numeric','numeric','numeric'))
